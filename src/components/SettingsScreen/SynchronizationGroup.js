...
import GoogleFitSynchronization from './GoogleFitSynchronization';
...
const SynchronizationGroup = (props) => {
    ...
    return (
        <View>
            ...
            {Platform.OS === 'android' && <GoogleFitSynchronization />}
            {Platform.OS === 'ios' && <AppleHealthSynchronization />}
            {/* <View
                style={{
                    borderBottomWidth: 1,
...
export default SynchronizationGroup;
